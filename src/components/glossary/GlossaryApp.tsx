...
export type GlossaryAppHandle = Readonly<{ focusSearch: () => void }>;

export const GlossaryApp = forwardRef<GlossaryAppHandle, { catalog: GlossaryCatalog; selectedSlug?: string; selectedStage?: string; onNavigate: (slug: string) => void; onSelectStage: (stage?: string) => void; onTitleChange: (title: string) => void }>(function GlossaryApp({ catalog, selectedSlug, selectedStage, onNavigate, onSelectStage, onTitleChange }, ref) {
